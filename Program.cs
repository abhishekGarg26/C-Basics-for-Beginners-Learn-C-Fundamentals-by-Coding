...
namespace HelloWorld
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            StringBuilderMethods stb = new StringBuilderMethods();
            stb.general();


            Exercise_4 exr4 = new Exercise_4();
            exr4.prgm5();


            FilesNDirectories fnd = new FilesNDirectories();
            fnd.directoryMethods();


            PathClass pc = new PathClass();
            pc.general();


            Exercise_5 exr5 = new Exercise_5();
            exr5.prgm2();
